...
plot 'results/sk-uniform.dat' using 1:2 lc 1 dt 1 title "skam-gass uniform l2", \
     'results/sk-nonuniform.dat' using 1:2 lc 1 dt 3 title "skam-gass nonuniform l2", \
     ...
     'results/cf-uniform.dat' using 1:2 lc 3 dt 1 title "cubicFit uniform l2", \
     'results/cf-nonuniform.dat' using 1:2 lc 3 dt 3 title "cubicFit nonuniform l2", \
...
plot 'results/sk-uniform.dat' using 1:3 lc 1 dt 2 title "skam-gass uniform linf", \
     'results/sk-nonuniform.dat' using 1:3 lc 1 dt 4 title "skam-gass nonuniform linf", \
     ...
     'results/cf-uniform.dat' using 1:3 lc 3 dt 2 title "cubicFit uniform linf", \
     'results/cf-nonuniform.dat' using 1:3 lc 3 dt 4 title "cubicFit nonuniform linf", \
